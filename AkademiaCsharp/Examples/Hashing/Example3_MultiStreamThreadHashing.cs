...
{
    public class Example3_MultiStreamThreadHashing : IExample
    {
        ...
        public Example3_MultiStreamThreadHashing(ISyncHasher hasher, int streamLength, int seed, int count)
        {
            _hasher = hasher;
