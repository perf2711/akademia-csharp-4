...
{
    public class Example4_LockSynchronizedThreadHashing : IExample
    {
        ...
        public Example4_LockSynchronizedThreadHashing(ISyncHasher hasher, int streamLength, int seed, int count)
        {
            _hasher = hasher;
