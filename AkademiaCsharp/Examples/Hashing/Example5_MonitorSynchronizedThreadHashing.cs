...
{
    public class Example5_MonitorSynchronizedThreadHashing : IExample
    {
        ...
        public Example5_MonitorSynchronizedThreadHashing(ISyncHasher hasher, int streamLength, int seed, int count)
        {
            _hasher = hasher;
