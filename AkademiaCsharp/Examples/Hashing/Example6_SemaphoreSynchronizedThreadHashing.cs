...
{
    public class Example6_SemaphoreSynchronizedThreadHashing : IExample
    {
        ...
        public Example6_SemaphoreSynchronizedThreadHashing(ISyncHasher hasher, int streamLength, int seed, int count)
        {
            _hasher = hasher;
